        ...
        <div className="mb-40">
          ...
          <motion.div variants={itemVariants} className="flex flex-col">
            <a 
              ...
              className="inline-block text-2xl md:text-[5vw] transition-all hover:opacity-40 break-words font-space font-bold tracking-tighter uppercase leading-none border-b-2 md:border-b-4 border-current pb-2 md:pb-4 self-start"
            >
